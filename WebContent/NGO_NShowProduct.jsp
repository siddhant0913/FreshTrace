...
<!-- stats-bottom -->
	<div class="services">
		<div class="container">
	       ...
	       <tr>
		    ...
		    <th class="col-md-1" style="width:97%"><label for="txt_Pid" style="color:black;">Product Name</label></th>
		    <th class="col-md-5" style="width:1%"><label for="txt_Pid" style="color:black;">Price</label></th>
		    <th class="col-md-1" style="width:97%"><label for="txt_Pid" style="color:black;">Total Quantity</label></th>
		    <th class="col-md-5" style="width:1%"><label for="txt_Pid" style="color:black;">Total Amount</label></th>
	...
	ResultSet rs=st.executeQuery("select * from tblngopurchase where Email_Id='"+Uemail+"'");
	while(rs.next())
	{
		id=Integer.parseInt(rs.getString(1));
		From_City=rs.getString(2);
		To_City=rs.getString(4);
		Product_Name=rs.getString(5);
		Km_Location=rs.getString(6);
