			...
			<div align="center">
				...
				<div>
					<div class="agileits_mail_grid_right1">
						<form role="form" action="payment_process" method="post">
							<div class="form-group">
								<table class="table table-responsive table-bordered">
									...
									<%
										...
										String id =(String)session.getAttribute("txt_id");
...
<tr>
										...
										<td><input type="text" class="form-control"
											readonly="readonly" name="farmeremail" value="<%=Farmer_Email%>"
											required id="txt_Pprice" placeholder="Enter Product Name"></td>
									</tr>
									...
									<tr>
										<td><label for="txt_Pdescription"
											style="color: black; font-size: 18px;">User Quantity
												:</label></td>
										<td class="col-md-6"><input type="text" value="<%=userquantity %>"
											class="form-control" name="userquantity" required readonly="readonly"
...
<tr>
									...
									<tr>
										<td class="col-md-6" colspan="2" align="center"><input
											...
											id="btn_Submit" Value="Update Product"></td>
									</tr>
									<%
										}
									%>
