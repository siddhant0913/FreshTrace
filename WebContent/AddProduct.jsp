				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					 <nav class="menu--iris">
						<ul class="nav navbar-nav menu__list">
				          ...
				          <li><a href="Farmer_Show_Transaction.jsp">Show Transaction</a></li>
...
<!-- mail -->
	...
	<div class="services">
		<div class="container">
		    ...
		    <tr>
			<td class="col-md-2"><label for="txt_Pname">Food Name:</label></td>
			<td class="col-md-6"><input type="text" class="form-control" name="txt_Pname" required id="txt_Pname" placeholder="Enter Food Name"></td>
			</tr>
			
			<tr>
			<td class="col-md-2"><label for="txt_Pquantity" >Quantity in Kg</label></td>
		    ...
		    <tr>
			<td class="col-md-2"><label for="txt_Pdescription" >Product Description:</label></td>
			<td class="col-md-6"><textarea class="form-control" name="txt_Pdescription" required id="txt_Pdescription" placeholder="Enter Product Description"></textarea></td>
			 ...
			 <tr>
			<td class="col-md-2"><label for="txt_Pprice" >Price per Kg</label></td>
			<td class="col-md-6"><input type="text" class="form-control" name="txt_Pprice" required id="txt_Pprice" placeholder="Enter Price"></td>
			</tr>
			 
			 <tr>
			<td class="col-md-2"><label for="txt_Pprice">Location</label></td>
			
			
          <td><select name="txt_Plocation" required>
		  ...
		  <%} %>
			  ...
			  <tr>
			<td class="col-md-2"><label for="txt_Pexpiry">Expiry Date</label></td>
			<td class="col-md-6">
