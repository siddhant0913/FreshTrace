					...
					<nav class="menu--iris">
						...
						<div class="w3_agileits_search">
							<ul class="nav navbar-nav menu__list">
								<li class="menu__item"><a href="RegisterPage.jsp"
									class="menu__link">Register Page</a></li>
								<li class="menu__item"><a href="Login.jsp"
									class="menu__link">Login Page</a></li>
						...
						<form action="Registration" method="post">
							<div align="center">
								<table border="1" width="100%">
									<tr>
										<td class="lable"><label for="txt_Uname">Select
												Roll:</label></td>
										<td class="lable"><select name="roll">
												<option selected="selected">Select Roll</option>
												<option value="Distributors">Distributors Info</option>
												<option value="Farmer">Farmer Info</option>
												<option value="Customer">Customer(NGO)</option>
										</select>
									</tr>
									<tr>
										<td><br></td>
									...
									<tr>
										<td class="lable"><label for="txt_Uname">User
												Name:</label></td>
										<td><input type="text" required name="txtName" /></td>
									</tr>
<tr>
										<td><br></td>
										<td></td>
									...
									<tr>
										<td class="lable"><label for="txt_Uname">Address:</label></td>
									...
									<tr>
										<td class="lable"><label for="txt_Uname">Gender:</label></td>

										<td align=left><input type="radio" name="rdoGender"
											value="Male" id="male" required /><label for="txt_Uname">Male</label>
											<input type="radio" name="rdoGender" value="FeMale"
											id="female" required /><label for="txt_Uname">Female</label></td>
									</tr>
									<tr>
										<td><br></td>
										<td></td>
									...
									<tr>
										<td class="lable"><label for="txt_Uname">Email:</label></td>
									...
									<tr>
										<td class="lable"><label for="txt_Uname">Contact
												No:</label></td>
										<td><input type="text" required
											pattern="[7-9]{1}[0-9]{9}" maxlength="10"
											title="Not a valid Phone Number" name="txtContact" /></td>
									</tr>
									<tr>
										<td><br></td>
										<td></td>
									...
									<tr>
										<td class="lable"><label for="txt_Uname">Password:</label></td>
										<td><input type="password" required name="passPassword" /></td>
									</tr>
									<tr>
