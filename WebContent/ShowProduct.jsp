				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu--iris">
						...
						<li class="menu__item "><a href="HomePage.jsp" class="menu__link">Home</a></li>
				          ...
				          <li><a href="Login">LOGOUT</a></li></ul>
...
<!-- stats-bottom -->
		...
		<div class="container">
	       ...
	       <tr>
		    ...
		    <th ><label for="txt_Pid" style="color:Black;font-size:18px;">Quantity</label></th>
		      ...
		      <th><label for="txt_Pid" style="color:Black;font-size:18px;">Manufacture Date</label></th>
	...
	ResultSet rs=st.executeQuery("select * from product_info where farmeremail='"+email+"'");
	while(rs.next())
	{
