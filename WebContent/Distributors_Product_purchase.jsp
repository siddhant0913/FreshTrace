			...
			<div align="center">
				...
				<div>
					<div class="agileits_mail_grid_right1">
						<form role="form" action="saleproduct" method="post">
						...
						String farmeremail="";
										...
										ResultSet rs = st
												.executeQuery("select * from product_info where id='" + ids
														+ "'");
										if (rs.next()) {
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											...
											value="<%=name%>" placeholder="Enter Product Name"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											readonly="readonly" name="txt_Pquantity" value="<%=qty%>"
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											readonly="readonly" name="txt_Pprice" value="<%=extra%>"
											required id="txt_Pprice" placeholder="Enter Product Name"></td>
									</tr>

<tr>
										<td><label for="txt_Pprice"
											style="color: black; font-size: 18px;">Farmer Email</label></td>
										<td><input type="text" class="form-control"
											readonly="readonly" name="farmeremail" value="<%=farmeremail%>"
											required id="txt_Pprice" placeholder="Enter Product Name"></td>
									</tr>
									...
									<tr>
										<td><label for="txt_Pdescription"
											style="color: black; font-size: 18px;">User Quantity
												:</label></td>
										<td class="col-md-6"><input type="number"
