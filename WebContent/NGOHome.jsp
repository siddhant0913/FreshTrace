...
<body>
	...
	<div class="banner">
		...
		<div class="agileits_w3layouts_banner_nav">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1>
						<a class="navbar-brand" href="#"><i>B</i><span>lockchain-Based
		...
		<div class="wthree_banner_info">
			<h2>
				<span>Agriculture</span>is the most healthful, most useful and the
				most noble employment of man
			</h2>
			<div class="agileinfo_more">
				<a class="link link--kumya" href="#" data-toggle="modal"
					data-target="#myModal"><span data-letters="Learn More">Learn
						More</span></a>
			</div>
		</div>
	</div>
	...
	<div class="banner-bottom">
		<div class="container">
			<h3>
				<span>agriculture</span> is best, enterprise is acceptable, but
				avoid being on a <span class="fixed_w3">fixed wage</span>
			</h3>
